...
bool ScatteredFeaturePieces::DesertPyramidPiece::postProcess(Level *level, Random *random, BoundingBox *chunkBB)
{
	...
	int stairsNorth = getOrientationData(Tile::sandstone_stairs_Id, 3);
	int stairsSouth = getOrientationData(Tile::sandstone_stairs_Id, 2);
	int stairsEast = getOrientationData(Tile::sandstone_stairs_Id, 0);
	int stairsWest = getOrientationData(Tile::sandstone_stairs_Id, 1);
	...
	placeBlock(level, Tile::sandstone_stairs_Id, stairsNorth, 2, 10, 0, chunkBB);
	placeBlock(level, Tile::sandstone_stairs_Id, stairsSouth, 2, 10, 4, chunkBB);
	placeBlock(level, Tile::sandstone_stairs_Id, stairsEast, 0, 10, 2, chunkBB);
	placeBlock(level, Tile::sandstone_stairs_Id, stairsWest, 4, 10, 2, chunkBB);
	...
	placeBlock(level, Tile::sandstone_stairs_Id, stairsNorth, width - 3, 10, 0, chunkBB);
	placeBlock(level, Tile::sandstone_stairs_Id, stairsSouth, width - 3, 10, 4, chunkBB);
	placeBlock(level, Tile::sandstone_stairs_Id, stairsEast, width - 5, 10, 2, chunkBB);
	placeBlock(level, Tile::sandstone_stairs_Id, stairsWest, width - 1, 10, 2, chunkBB);
	...
	placeBlock(level, Tile::sandstone_stairs_Id, stairsNorth, 2, 4, 5, chunkBB);
	placeBlock(level, Tile::sandstone_stairs_Id, stairsNorth, 2, 3, 4, chunkBB);
	placeBlock(level, Tile::sandstone_stairs_Id, stairsNorth, width - 3, 4, 5, chunkBB);
	placeBlock(level, Tile::sandstone_stairs_Id, stairsNorth, width - 3, 3, 4, chunkBB);
	...
	placeBlock(level, Tile::sandstone_stairs_Id, 0, 1, 1, 2, chunkBB);
	placeBlock(level, Tile::sandstone_stairs_Id, 0, width - 2, 1, 2, chunkBB);
	placeBlock(level, Tile::stone_slab_Id, StoneSlabTile::SAND_SLAB, 1, 2, 2, chunkBB);
	placeBlock(level, Tile::stone_slab_Id, StoneSlabTile::SAND_SLAB, width - 2, 2, 2, chunkBB);
	placeBlock(level, Tile::sandstone_stairs_Id, stairsWest, 2, 1, 2, chunkBB);
	placeBlock(level, Tile::sandstone_stairs_Id, stairsEast, width - 3, 1, 2, chunkBB);
	...
	placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, 10, 0, 7, chunkBB);
	placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, 10, 0, 8, chunkBB);
	placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, 9, 0, 9, chunkBB);
	placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, 11, 0, 9, chunkBB);
	placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, 8, 0, 10, chunkBB);
	placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, 12, 0, 10, chunkBB);
	placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, 7, 0, 10, chunkBB);
	placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, 13, 0, 10, chunkBB);
	placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, 9, 0, 11, chunkBB);
	placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, 11, 0, 11, chunkBB);
	placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, 10, 0, 12, chunkBB);
	placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, 10, 0, 13, chunkBB);
	placeBlock(level, Tile::stained_hardened_clay_Id, blue, 10, 0, 10, chunkBB);

	// outdoor decoration
	for (int x = 0; x <= width - 1; x += width - 1)
	{
		placeBlock(level, Tile::sandstone_Id, SandStoneTile::TYPE_SMOOTHSIDE, x, 2, 1, chunkBB);
		placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, x, 2, 2, chunkBB);
		...
		placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, x, 3, 2, chunkBB);
		placeBlock(level, Tile::sandstone_Id, SandStoneTile::TYPE_SMOOTHSIDE, x, 3, 3, chunkBB);
		placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, x, 4, 1, chunkBB);
		placeBlock(level, Tile::sandstone_Id, SandStoneTile::TYPE_HEIROGLYPHS, x, 4, 2, chunkBB);
		placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, x, 4, 3, chunkBB);
		placeBlock(level, Tile::sandstone_Id, SandStoneTile::TYPE_SMOOTHSIDE, x, 5, 1, chunkBB);
		placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, x, 5, 2, chunkBB);
		placeBlock(level, Tile::sandstone_Id, SandStoneTile::TYPE_SMOOTHSIDE, x, 5, 3, chunkBB);
		placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, x, 6, 1, chunkBB);
		placeBlock(level, Tile::sandstone_Id, SandStoneTile::TYPE_HEIROGLYPHS, x, 6, 2, chunkBB);
		placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, x, 6, 3, chunkBB);
		placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, x, 7, 1, chunkBB);
		placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, x, 7, 2, chunkBB);
		placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, x, 7, 3, chunkBB);
	...
	for (int x = 2; x <= width - 3; x += width - 3 - 2)
	{
		...
		placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, x, 2, 0, chunkBB);
		placeBlock(level, Tile::sandstone_Id, SandStoneTile::TYPE_SMOOTHSIDE, x + 1, 2, 0, chunkBB);
		placeBlock(level, Tile::sandstone_Id, SandStoneTile::TYPE_SMOOTHSIDE, x - 1, 3, 0, chunkBB);
		placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, x, 3, 0, chunkBB);
		placeBlock(level, Tile::sandstone_Id, SandStoneTile::TYPE_SMOOTHSIDE, x + 1, 3, 0, chunkBB);
		placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, x - 1, 4, 0, chunkBB);
		...
		placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, x, 5, 0, chunkBB);
		placeBlock(level, Tile::sandstone_Id, SandStoneTile::TYPE_SMOOTHSIDE, x + 1, 5, 0, chunkBB);
		placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, x - 1, 6, 0, chunkBB);
		placeBlock(level, Tile::sandstone_Id, SandStoneTile::TYPE_HEIROGLYPHS, x, 6, 0, chunkBB);
		placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, x + 1, 6, 00, chunkBB);
		placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, x - 1, 7, 0, chunkBB);
		placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, x, 7, 0, chunkBB);
		placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, x + 1, 7, 0, chunkBB);
	...
	placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, 9, 5, 0, chunkBB);
	placeBlock(level, Tile::sandstone_Id, SandStoneTile::TYPE_HEIROGLYPHS, 10, 5, 0, chunkBB);
	placeBlock(level, Tile::stained_hardened_clay_Id, baseDecoColor, 11, 5, 0, chunkBB);
	...
	placeBlock(level, Tile::stone_pressure_plate_Id, 0, 10, -11, 10, chunkBB);
...
bool ScatteredFeaturePieces::JunglePyramidPiece::postProcess(Level *level, Random *random, BoundingBox *chunkBB)
{
	...
	int stairsNorth = getOrientationData(Tile::stone_stairs_Id, 3);
	int stairsSouth = getOrientationData(Tile::stone_stairs_Id, 2);
	int stairsEast = getOrientationData(Tile::stone_stairs_Id, 0);
	int stairsWest = getOrientationData(Tile::stone_stairs_Id, 1);
	...
	placeBlock(level, Tile::stone_stairs_Id, stairsNorth, 5, 9, 6, chunkBB);
	placeBlock(level, Tile::stone_stairs_Id, stairsNorth, 6, 9, 6, chunkBB);
	placeBlock(level, Tile::stone_stairs_Id, stairsSouth, 5, 9, 8, chunkBB);
	placeBlock(level, Tile::stone_stairs_Id, stairsSouth, 6, 9, 8, chunkBB);

	// front stairs
	placeBlock(level, Tile::stone_stairs_Id, stairsNorth, 4, 0, 0, chunkBB);
	placeBlock(level, Tile::stone_stairs_Id, stairsNorth, 5, 0, 0, chunkBB);
	placeBlock(level, Tile::stone_stairs_Id, stairsNorth, 6, 0, 0, chunkBB);
	placeBlock(level, Tile::stone_stairs_Id, stairsNorth, 7, 0, 0, chunkBB);

	// indoor stairs up
	placeBlock(level, Tile::stone_stairs_Id, stairsNorth, 4, 1, 8, chunkBB);
	placeBlock(level, Tile::stone_stairs_Id, stairsNorth, 4, 2, 9, chunkBB);
	placeBlock(level, Tile::stone_stairs_Id, stairsNorth, 4, 3, 10, chunkBB);
	placeBlock(level, Tile::stone_stairs_Id, stairsNorth, 7, 1, 8, chunkBB);
	placeBlock(level, Tile::stone_stairs_Id, stairsNorth, 7, 2, 9, chunkBB);
	placeBlock(level, Tile::stone_stairs_Id, stairsNorth, 7, 3, 10, chunkBB);
	...
	placeBlock(level, Tile::stone_stairs_Id, stairsEast, 4, 4, 5, chunkBB);
	placeBlock(level, Tile::stone_stairs_Id, stairsWest, 7, 4, 5, chunkBB);

	// indoor stairs down
	for (int i = 0; i < 4; i++)
	{
		placeBlock(level, Tile::stone_stairs_Id, stairsSouth, 5, 0 - i, 6 + i, chunkBB);
		placeBlock(level, Tile::stone_stairs_Id, stairsSouth, 6, 0 - i, 6 + i, chunkBB);
	...
	// trip wire trap 1
	placeBlock(level, Tile::tripwire_hook_Id, getOrientationData(Tile::tripwire_hook_Id, Direction::EAST) | TripWireSourceTile::MASK_ATTACHED, 1, -3, 8, chunkBB);
	placeBlock(level, Tile::tripwire_hook_Id, getOrientationData(Tile::tripwire_hook_Id, Direction::WEST) | TripWireSourceTile::MASK_ATTACHED, 4, -3, 8, chunkBB);
	...
	placeBlock(level, Tile::redstone_wire_Id, 0, 5, -3, 7, chunkBB);
	placeBlock(level, Tile::redstone_wire_Id, 0, 5, -3, 6, chunkBB);
	placeBlock(level, Tile::redstone_wire_Id, 0, 5, -3, 5, chunkBB);
	placeBlock(level, Tile::redstone_wire_Id, 0, 5, -3, 4, chunkBB);
	placeBlock(level, Tile::redstone_wire_Id, 0, 5, -3, 3, chunkBB);
	placeBlock(level, Tile::redstone_wire_Id, 0, 5, -3, 2, chunkBB);
	placeBlock(level, Tile::redstone_wire_Id, 0, 5, -3, 1, chunkBB);
	placeBlock(level, Tile::redstone_wire_Id, 0, 4, -3, 1, chunkBB);
	...
	// trip wire trap 2
	placeBlock(level, Tile::tripwire_hook_Id, getOrientationData(Tile::tripwire_hook_Id, Direction::NORTH) | TripWireSourceTile::MASK_ATTACHED, 7, -3, 1, chunkBB);
	placeBlock(level, Tile::tripwire_hook_Id, getOrientationData(Tile::tripwire_hook_Id, Direction::SOUTH) | TripWireSourceTile::MASK_ATTACHED, 7, -3, 5, chunkBB);
	...
	placeBlock(level, Tile::redstone_wire_Id, 0, 8, -3, 6, chunkBB);
	placeBlock(level, Tile::redstone_wire_Id, 0, 9, -3, 6, chunkBB);
	placeBlock(level, Tile::redstone_wire_Id, 0, 9, -3, 5, chunkBB);
	placeBlock(level, Tile::mossy_cobblestone_Id, 0, 9, -3, 4, chunkBB);
	...
	placeBlock(level, Tile::mossy_cobblestone_Id, 0, 4, -3, 5, chunkBB);
	placeBlock(level, Tile::mossy_cobblestone_Id, 0, 5, -2, 5, chunkBB);
	placeBlock(level, Tile::mossy_cobblestone_Id, 0, 5, -1, 5, chunkBB);
	placeBlock(level, Tile::mossy_cobblestone_Id, 0, 6, -3, 5, chunkBB);
	placeBlock(level, Tile::mossy_cobblestone_Id, 0, 7, -2, 5, chunkBB);
	placeBlock(level, Tile::mossy_cobblestone_Id, 0, 7, -1, 5, chunkBB);
	placeBlock(level, Tile::mossy_cobblestone_Id, 0, 8, -3, 5, chunkBB);
	...
	placeBlock(level, Tile::mossy_cobblestone_Id, 0, 10, -2, 9, chunkBB);
	placeBlock(level, Tile::redstone_wire_Id, 0, 8, -2, 9, chunkBB);
	placeBlock(level, Tile::redstone_wire_Id, 0, 8, -2, 10, chunkBB);
	placeBlock(level, Tile::redstone_wire_Id, 0, 10, -1, 9, chunkBB);
	placeBlock(level, Tile::sticky_piston_Id, Facing::UP, 9, -2, 8, chunkBB);
	placeBlock(level, Tile::sticky_piston_Id, getOrientationData(Tile::sticky_piston_Id, Facing::WEST), 10, -2, 8, chunkBB);
	placeBlock(level, Tile::sticky_piston_Id, getOrientationData(Tile::sticky_piston_Id, Facing::WEST), 10, -1, 8, chunkBB);
...
void ScatteredFeaturePieces::JunglePyramidPiece::MossStoneSelector::next(Random *random, int worldX, int worldY, int worldZ, bool isEdge)
{
	...
	{
		nextId = Tile::mossy_cobblestone_Id;
	}
}
...
bool ScatteredFeaturePieces::SwamplandHut::postProcess(Level *level, Random *random, BoundingBox *chunkBB)
{
	...
	// floor and ceiling
	generateBox(level, chunkBB, 1, 1, 1, 5, 1, 7, Tile::planks_Id, TreeTile::SPRUCE_TRUNK, Tile::planks_Id, TreeTile::SPRUCE_TRUNK, false);
	generateBox(level, chunkBB, 1, 4, 2, 5, 4, 7, Tile::planks_Id, TreeTile::SPRUCE_TRUNK, Tile::planks_Id, TreeTile::SPRUCE_TRUNK, false);
	generateBox(level, chunkBB, 2, 1, 0, 4, 1, 0, Tile::planks_Id, TreeTile::SPRUCE_TRUNK, Tile::planks_Id, TreeTile::SPRUCE_TRUNK, false);

	// walls
	generateBox(level, chunkBB, 2, 2, 2, 3, 3, 2, Tile::planks_Id, TreeTile::SPRUCE_TRUNK, Tile::planks_Id, TreeTile::SPRUCE_TRUNK, false);
	generateBox(level, chunkBB, 1, 2, 3, 1, 3, 6, Tile::planks_Id, TreeTile::SPRUCE_TRUNK, Tile::planks_Id, TreeTile::SPRUCE_TRUNK, false);
	generateBox(level, chunkBB, 5, 2, 3, 5, 3, 6, Tile::planks_Id, TreeTile::SPRUCE_TRUNK, Tile::planks_Id, TreeTile::SPRUCE_TRUNK, false);
	generateBox(level, chunkBB, 2, 2, 7, 4, 3, 7, Tile::planks_Id, TreeTile::SPRUCE_TRUNK, Tile::planks_Id, TreeTile::SPRUCE_TRUNK, false);

	// pillars
	generateBox(level, chunkBB, 1, 0, 2, 1, 3, 2, Tile::log_Id, Tile::log_Id, false);
	generateBox(level, chunkBB, 5, 0, 2, 5, 3, 2, Tile::log_Id, Tile::log_Id, false);
	generateBox(level, chunkBB, 1, 0, 7, 1, 3, 7, Tile::log_Id, Tile::log_Id, false);
	generateBox(level, chunkBB, 5, 0, 7, 5, 3, 7, Tile::log_Id, Tile::log_Id, false);
	...
	placeBlock(level, Tile::flower_pot_Id, FlowerPotTile::TYPE_MUSHROOM_RED, 1, 3, 5, chunkBB);
	...
	// ceiling edges
	int south = getOrientationData(Tile::oak_stairs_Id, StairTile::DIR_NORTH);
	int east = getOrientationData(Tile::oak_stairs_Id, StairTile::DIR_WEST);
	int west = getOrientationData(Tile::oak_stairs_Id, StairTile::DIR_EAST);
	int north = getOrientationData(Tile::oak_stairs_Id, StairTile::DIR_SOUTH);

	generateBox(level, chunkBB, 0, 4, 1, 6, 4, 1, Tile::spruce_stairs_Id, south, Tile::spruce_stairs_Id, south, false);
	generateBox(level, chunkBB, 0, 4, 2, 0, 4, 7, Tile::spruce_stairs_Id, west, Tile::spruce_stairs_Id, west, false);
	generateBox(level, chunkBB, 6, 4, 2, 6, 4, 7, Tile::spruce_stairs_Id, east, Tile::spruce_stairs_Id, east, false);
	generateBox(level, chunkBB, 0, 4, 8, 6, 4, 8, Tile::spruce_stairs_Id, north, Tile::spruce_stairs_Id, north, false);
